...
namespace ScrumFactory.Composition
{
    public static class CommandBehavior
    {
        ...
        #region TheCommandParameter

         /// <summary>
        /// TheCommandToRun : The actual ICommand to run
        /// </summary>
        public static readonly DependencyProperty TheCommandParameterProperty =
            DependencyProperty.RegisterAttached("TheCommandParameter", 
                typeof(object), 
                typeof(CommandBehavior));

        /// <summary>
        /// Gets the TheCommandParameter property.  
        /// </summary>
        public static object GetTheCommandParameter(DependencyObject d)
        {
            return d.GetValue(TheCommandParameterProperty);
        }

        /// <summary>
        /// Sets the TheCommandParameter property.  
        /// </summary>
        public static void SetTheCommandParameter(DependencyObject d, object value)
        {
            d.SetValue(TheCommandParameterProperty, value);
        }
        #endregion
    ...
    sealed class EventHooker
    {
        ...
        private void OnEventRaised(object sender, EventArgs e)
        {
            ...
            // WPF FIRES SELECTION CHANGE ON LOAD - I DONT WANT THAT
            string eventName = (sender as DependencyObject).GetValue(CommandBehavior.RoutedEventNameProperty).ToString();
            FrameworkElement element = sender as FrameworkElement;
            if (element!=null && !element.IsLoaded && eventName.Equals("SelectionChanged"))
                return;            
            
            object parameter = (sender as DependencyObject).GetValue(CommandBehavior.TheCommandParameterProperty);
