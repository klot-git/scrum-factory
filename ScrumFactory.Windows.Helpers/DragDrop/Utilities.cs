...
namespace ScrumFactory.Windows.Helpers.DragDrop {
	...
	internal static class Utilities {
		...
		internal static bool HasVerticalOrientation(FrameworkElement itemContainer)
		{
        ...
        internal static void InsertItemInItemsControl(ItemsControl itemsControl, object itemToInsert, int insertionIndex)
		{
			if (itemToInsert != null)
			{
				...
				else if (itemsSource is IList)
				{
                    ...
                    IList list = ((System.Windows.Data.ListCollectionView)itemsSource).SourceCollection as IList;
        ...
        internal static int RemoveItemFromItemsControl(ItemsControl itemsControl, object itemToRemove)
		{
        ...
        internal static bool IsInFirstHalf(FrameworkElement container, Point clickedPoint, bool hasVerticalOrientation)
		{
        ...
        internal static bool IsMovementBigEnough(Point initialMousePosition, Point currentPosition)
		{
