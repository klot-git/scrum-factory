...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template name="timeLine">
    ...
    <Paragraph>
      ...
      <Bold>
        <xsl:value-of select="count(Project/Sprints/Sprint)"/>
      </Bold>
      ...
      <Bold>
        <xsl:call-template name="formatDate">
          <xsl:with-param name="dateTime" select="Project/Sprints/Sprint[1]/StartDate" />
        </xsl:call-template>
      </Bold>
      ...
      <Bold>
        <xsl:call-template name="formatDate">
          <xsl:with-param name="dateTime" select="Project/Sprints/Sprint[last()]/EndDate" />
        </xsl:call-template>
      </Bold>.
      <LineBreak/>
