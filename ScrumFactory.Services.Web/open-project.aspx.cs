...
namespace ScrumFactory.Services.Web {
    public partial class open_project : System.Web.UI.Page {
        protected void Page_Load(object sender, EventArgs e) {
            ...
            Response.Redirect(clientServer + "/SFClient2012/ScrumFactory.application?server=" + server + "&projectNumber=" + Page.RouteData.Values["projectNumber"], true);
        }
    }
}