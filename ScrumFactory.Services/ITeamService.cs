namespace ScrumFactory.Services {
    ...
    public interface ITeamService {
        ...
        [OperationContract]
        ICollection<MemberProfile> GetMembers(string filter, int availability, string clientName, bool activeOnly, string workingWith, int top, bool includeProjects, bool includeProposals, bool includeSupport);
